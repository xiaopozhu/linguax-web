...
keywords:
  ...
  - best mac mouse fix alternative
  - macos mouse gesture app
  - mouse button mapping macos
  - smooth scrolling mouse app mac
---
...
- [How to Map Mouse Side Buttons on macOS](./map-mouse-side-buttons-macos.md)
