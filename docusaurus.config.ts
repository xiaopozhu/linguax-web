...
const config: Config = {
  ...
  // (曾因 fallback locale 下 ./sibling.md 相对链接解析不出路由而只能设 warn,
  //  那批链接已在 commit 81feb2f 改为绝对路径,现在可以收紧。)
  ...
  customFields: {
    ...
    // Beta 下载入口默认关闭；有新的公开测试版本时显式置 true 重新开放。
    macOSBetaDownloadEnabled: process.env.MACOS_BETA_DOWNLOAD_ENABLED === 'true',
  },
